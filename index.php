        ...
        <div class="row">
          <div class="col-md-12"><div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-4">
                  <a href="produk.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Dashboard Produk</a>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
                <div class="col-md-4">
                  <a href="staff.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Dashboard Staff</a>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
                <div class="col-md-4">
                  <a href="transaksi.html" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Dashboard Transaksi</a>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
  ...
  $(function () {
    ...
    var chartData = {
      ...
      datasets: [
      {
        ...
        {
          label               : 'Personal Hyegine',
          backgroundColor     : '#918aeb',
          borderColor         : '#918aeb',
          pointRadius          : false,
          pointColor          : '#918aeb',
          pointStrokeColor    : 'rgba(24, 163, 61,1)',
          pointHighlightFill  : '#918aeb',
          pointHighlightStroke: '#918aeb',
          data                : [30, 45,	82,	98]
        },
        {
          ...
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(0, 255, 225,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(0, 255, 225,1)',
          data                : [25,	30,	64,	49]
        },{
          label               : 'Frozen Food',
          backgroundColor     : 'rgba(60,141,188,0.9)',
        ...
        ,
        {
          label               : 'Houseware',
          backgroundColor     : 'rgba(60,141,188,0.9)',
          borderColor         : 'rgba(217, 0, 255,1)',
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(217, 0, 255,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(217, 0, 255,1)',
          data                : [57,	32,	32,	90]
        },
        {
          label               : 'Fish and Meat',
          backgroundColor     : 'rgba(60,141,188,0.9)',
          borderColor         : 'rgba(255, 92, 160,1)',
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(255, 92, 160,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(255, 92, 160,1)',
          data                : [73,	98,	70,	35]
        },
        {
          label               : 'Snacks',
        ...
        },
        {
          ...
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(255, 149, 0,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(255, 149, 0,1)',
          data                : [72,	53,	81,	49]
        },
        {
          label               : 'Cosmetics',
          ...
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(255, 251, 0,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(255, 251, 0,1)',
          data                : [50,	89,	79,	33]
        },
        {
          label               : 'Baby needs',
          ...
          pointRadius          : false,
          pointColor          : '#3b8bba',
          pointStrokeColor    : 'rgba(145, 71, 255,1)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(145, 71, 255,1)',
          data                : [47,	90,	55,	72]
        }
      ]
    }
